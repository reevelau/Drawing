...
namespace Drawing.Engine.Test
{
    public class DrawingServiceTest 
    {
        ...
        public void ShouldCreateCanvas()
        {
            ...
            var service = new DrawingService((ICanvasFactory)mock.Object);
        ...
        public void ShouldCreateLine()
        {
            ...
            var service = new DrawingService(canvasFactory.Object, cmdFactory.Object);
            service.CreateCanvas(10,10);
